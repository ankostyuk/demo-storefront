...
<div class="col1">
    <h1>Редактирование аккаунта менеджера</h1>
    ...
    <form:form cssClass="basic" modelAttribute="login">
        ...
        <div class="field">
            <input type="submit" value="Сохранить аккаунт менеджера" />
        </div>
    </form:form>
</div>
<div class="col2">
    <ul>
        <li><a href="<spring:url value="/secured/admin/account/manager/delete/{id}">
